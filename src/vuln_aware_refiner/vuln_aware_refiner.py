...
class VulnAwareRefiner(AIAgent, Generable):
    ...
    def validate_llm_response(
        ...
        if invalid_loop_ids:
            ...
            return (AgentAction.RETRY, user_prompt, initial_coverage, "invalid_unwindset_loop_ids")
        ...
        while user_prompt and attempts < self._max_attempts:
            ...
            if action == AgentAction.RETRY and attempts < self._max_attempts:
                ...
                self.emit_refinement_accepted(
                    "Accepted vulnerability-aware refinement",
                    taskId=task_id,
                    numLoopUnwindingsSet=llm_response.num_loop_unwindings_set,
                )
